...
get_menu_opciones() {
    ...
    echo -e "\t\t\tMARIADB\n"	
    echo -e "\n\t----------- GENERAL -----------"
    echo -e "\t\t1. Datos Foreign Keys alumno"
    echo -e "\t\t2. Datos Relaciones alumno"
...
get_selects_relaciones_menu() {
    ...
    do  
		...
		echo -e "\t\t1. Select One-One matricula"
		echo -e "\t\t2. Select Many-Many materia"
		echo -e "\t\t3. Select One-Many pension"
